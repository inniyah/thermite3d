...
private:
	...
	PolyVox::int32 m_iRegionTimeStamps[THERMITE_VOLUME_SIDE_LENGTH_IN_REGIONS][THERMITE_VOLUME_SIDE_LENGTH_IN_REGIONS][THERMITE_VOLUME_SIDE_LENGTH_IN_REGIONS];
};
